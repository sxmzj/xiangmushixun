...
public class TestApi {
    ...
    public JSONObject login(@RequestBody JSONObject user, HttpServletResponse resonse) {
        ...
        if (user_area.equals("86") && user_phone.equals("123456") && user_pwd.equals("netease123")) {
        ...
        } else if (!user_pwd.equals("netease123") || !user_phone.equals("123456")||!user_area.equals("86")) {
    ...
    //  /common/skuList?goodId=1&name=abc
    @ApiOperation("获取商品信息")
    ...
    @ApiOperation("获取商品信息")
    @GetMapping("/common/skuListwithoutId")
    public JSONObject getGoodInfo
            ...
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("login") && cookie.getValue().equals("true")) {
                    if (!Objects.isNull(id)) {
                        ...
                        message.put("message", "id必须为null");
                    } else if (receiverName.equals("张三") && cellPhone.equals("123456789111")) {
