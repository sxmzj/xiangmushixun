...
<div class="regist">
    ...
    <form action="MyServletPost" method="post" class="form" name="Api" >
        ...
        <div class="textarea">
            post：<br><textarea name="post"  style="height: 300px;width: 100%"><%=blanknull(Api.getPost01())%></textarea>
        </div>
        <div class="textarea" style="padding-left: 20px">
            get ：<br><textarea name="get" style="height: 300px;width: 100%"><%=blanknull(Api.getGet01()) %></textarea>
        </div>
    </form>
</div>
</body>
