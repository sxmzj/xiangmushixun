...
Note
   ...
   the driver will com.ck.report close the connection and com.ck.report
   ...
   metrics, and com.ck.report them via the configured logger every
...
6.2. How to Report Connector/J Bugs or Problems
   ...
   The normal place to com.ck.report bugs is http://bugs.mysql.com/,
   ...
   Writing a good bug com.ck.report takes patience, but doing it right
   the first time saves time both for us and for yourself. A
   good bug com.ck.report, containing a full test case for the bug,
   makes it very likely that we will fix the bug in the next
   release.

   This section will help you write your com.ck.report correctly so
   that you don't waste your time doing things that may not help
   us much or at all.

   If you have a repeatable bug com.ck.report, please com.ck.report it to the
   bugs database at http://bugs.mysql.com/. Any bug that we are
   able to repeat has a high chance of being fixed in the next
   MySQL release.

   To com.ck.report other problems, you can use one of the MySQL
   mailing lists.
   ...
   write a couple more lines in your com.ck.report than to wait longer
   for the answer if we must ask you to provide information that
   was missing from the initial com.ck.report.
   ...
   100, the bug com.ck.report is useless without it. Very often we get
   questions like, "Why doesn't this work for me?" Then we find
   that the feature requested wasn't implemented in that MySQL
   version, or that a bug described in a com.ck.report has already been
   ...
   connection to MySQL:
     ...
     * getNewConnection() - Use this if you need to get a new
       connection for your bug com.ck.report (i.e. there's more than
...
public static void main(String[] args) throws Exception {
   ...
   your bug com.ck.report to http://bugs.mysql.com/.
...
A.1.5. Changes in MySQL Connector/J 5.1.3 (10 September 2007)
   ...
   Bugs fixed:
     ...
     * CallableStatement.executeBatch() doesn't work when
       ...
       com.ck.report all paramters as "IN" paramters but allow callers
...
Note
     ...
     * Client options not sent correctly when using SSL, leading
       ...
       Thanks to Don Cohen for the bug com.ck.report, testcase and
...
useServerPrepStmts=true
     ...
     * Usage Advisor now detects empty results sets and does not
       com.ck.report on columns not referenced in those empty sets.
...
A.3.2. Changes in MySQL Connector/J 3.1.14 (10-19-2006)
   ...
   Bugs fixed:
     ...
     * Escape of quotes in client-side prepared statements
       parsing not respected. Patch covers more than bug com.ck.report,
...
A.4.8. Changes in MySQL Connector/J 3.0.10 (13 January 2004)
   ...
   Bugs fixed:
     ...
     * Fixed mappings in SQLError to com.ck.report deadlocks with
       SQLStates of 41000.
       (Bug#2006: http://bugs.mysql.com/2006)
