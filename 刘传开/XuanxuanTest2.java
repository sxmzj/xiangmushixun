...
public class XuanxuanTest2 {
    ...
    public void testAdd() throws InterruptedException, UiObjectNotFoundException {
        ...
        Thread.sleep(3000);
        mDevice.findObject(By.desc("Nnum1")).click();
        mDevice.findObject(By.desc("Nnum2")).click();
        mDevice.click(0,463);
        //点击创建按钮
    ...
    public void testEnter() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(3000);
        mDevice.click(0,160);
        mDevice.findObject(new UiSelector().className("android.widget.EditText").textContains("发送消息")).legacySetText("12345678");
        Thread.sleep(3000);
    ...
    public void testLogin() throws UiObjectNotFoundException, InterruptedException {
        mDevice.findObject(new UiSelector().className("android.widget.EditText").
                textContains("服务器")).legacySetText("http://10.7.90.203:11443");
        Thread.sleep(3000);
        mDevice.findObject(new UiSelector().className("android.widget.EditText")
